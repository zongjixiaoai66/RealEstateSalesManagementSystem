<template>
    <div style="backgroundImage: url('/fangdicanxiaoshou/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">房地产销售管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="客户姓名" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="客户姓名"  />
                        </el-form-item>
                        ...
                        <el-form-item label="客户身份证号" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuIdNumber" autocomplete="off" placeholder="客户身份证号"  />
                        </el-form-item>
                        ...
                        <el-form-item label="销售经理姓名" class="input" v-if="tableName=='yuangong'">
                            <el-input v-model="ruleForm.yuangongName" autocomplete="off" placeholder="销售经理姓名"  />
                        </el-form-item>
