<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='客户姓名' prop="yonghuName">
               <el-input v-model="ruleForm.yonghuName"  placeholder='客户姓名' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='客户身份证号' prop="yonghuIdNumber">
               <el-input v-model="ruleForm.yonghuIdNumber"  placeholder='客户身份证号' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yuangong'"  label='销售经理姓名' prop="yuangongName">
               <el-input v-model="ruleForm.yuangongName"  placeholder='销售经理姓名' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yuangong'"  label='邮箱' prop="yuangongEmail">
               <el-input v-model="ruleForm.yuangongEmail"  placeholder='邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
