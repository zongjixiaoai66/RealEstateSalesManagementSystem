    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="分数" prop="kehudafenNumber">
                       <el-input v-model="ruleForm.kehudafenNumber"
                                 placeholder="分数" clearable  :readonly="ro.kehudafenNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="分数" prop="kehudafenNumber">
                           <el-input v-model="ruleForm.kehudafenNumber"
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`kehudafen/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.kehudafenCrossAddOrUpdateFlag = false;
                                        this.parent.search();
