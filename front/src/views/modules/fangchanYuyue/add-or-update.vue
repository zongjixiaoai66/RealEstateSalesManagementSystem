        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='fangchan'">
                    <el-form-item class="select" v-if="type!='info'"  label="房产信息" prop="fangchanId">
                        <el-select v-model="ruleForm.fangchanId" :disabled="ro.fangchanId" filterable placeholder="请选择房产信息" @change="fangchanChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='fangchan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房产编号" prop="fangchanUuidNumber">
                        <el-input v-model="fangchanForm.fangchanUuidNumber"
                                  placeholder="房产编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='fangchan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房产名" prop="fangchanName">
                        <el-input v-model="fangchanForm.fangchanName"
                                  placeholder="房产名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='fangchan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房产户型" prop="fangchanValue">
                        <el-input v-model="fangchanForm.fangchanValue"
                                  placeholder="房产户型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="24" v-if="sessionTable !='fangchan' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='fangchan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房产地址" prop="fangchanAddress">
                        <el-input v-model="fangchanForm.fangchanAddress"
                                  placeholder="房产地址" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='fangchan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房屋面积" prop="fangchanMianjis">
                        <el-input v-model="fangchanForm.fangchanMianjis"
                                  placeholder="房屋面积" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='fangchan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="所在区域" prop="fangchanQuyu">
                        <el-input v-model="fangchanForm.fangchanQuyu"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="预约时间" prop="fangchanYuyueTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.fangchanYuyueTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.fangchanYuyueTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.fangchanYuyueTime" label="预约时间" prop="fangchanYuyueTime">
                            <span v-html="ruleForm.fangchanYuyueTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`fangchanYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.fangchanYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
